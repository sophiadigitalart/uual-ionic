...
import {  hammer, calendar, help, informationCircleOutline, logIn, logOut, person, personAdd } from 'ionicons/icons';
...
const routes = {
  appPages: [
    ...
    { title: 'Speakers', path: '/tabs/speakers', icon: person },
    { title: 'Map', path: '/tabs/map', icon: help },
